  ...
  return (
    <MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
      <AnimationContainer delay={0.1} className="w-full">
        ...
        <p className="mt-4">
          Welcome to Cayus. These terms and conditions outline the rules and
          regulations for the use of Cayus&apos;s website and services.
        </p>

        <h2 className="text-xl font-medium mt-8">Acceptance of Terms</h2>

        <p className="mt-8 text-muted-foreground">
          By accessing and using Cayus, you accept and agree to be bound by
        ...
        <p className="mt-8 text-muted-foreground">
          Cayus reserves the right to modify these terms at any time. We will
        ...
        <p className="mt-8">
          To use Cayus, you must be at least 18 years old and capable of
        ...
        <div className="mt-8">
          You agree not to use Cayus for any unlawful or prohibited activities,
        ...
        <p className="mt-8 text-muted-foreground">
          Cayus provides a URL shortening service that allows you to create
        ...
        <p className="mt-8 text-muted-foreground">
          Cayus offers analytics for your shortened URLs. You agree to use this
        ...
        <p className="mt-8 text-muted-foreground">
          You retain ownership of any content you upload or create using Cayus.
          However, by uploading or creating content, you grant Cayus a
        ...
        <p className="mt-8 text-muted-foreground">
          You are solely responsible for the content you upload or create. Cayus
        ...
        <p className="mt-8 text-muted-foreground">
          Cayus reserves the right to suspend or terminate your account at any
        ...
        <p className="mt-8 text-muted-foreground">
          Cayus is provided on an &quot;as is&quot; and &quot;as available&quot;
        ...
        <p className="mt-8 text-muted-foreground">
          In no event shall Cayus be liable for any indirect, incidental,
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          please contact us at renaud@cayus.ai.
        </p>

        <p className="mt-8 font-medium">
          By using Cayus, you acknowledge that you have read, understood, and
